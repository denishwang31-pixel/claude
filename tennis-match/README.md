...
- 검증: `npm run test:engine`(268) · `npm run test:tournament`(27) · `npm run test:rules`(41, Java 필요)
...
| 일정 | 모임 등록, RSVP(참석 의사) |
| 대진 | VBA v5 엔진(잡복 금지·타임 중복 방지·페어 누적), 우선순위 드래그, 휴식점수, **커플/고정페어 제약** |
| 랭킹 | 클럽 랭킹, 내 커리어(케미·H2H), 시즌 결산 |
| 더보기 | **대회**(예선+토너먼트+시드) · **NTRP** · **출석** · **커플/페어** · 회비 · 게시판 · 게스트 모집 · 코트 검색 · 회원 |
