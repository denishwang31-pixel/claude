...
- 검증: `npm run test:engine`(442) · `test:tournament`(40) · `test:schedule`(24) · `test:rules`(62, Java 필요)

## 주요 기능
| 탭 | 기능 |
|---|---|
| 홈 | 다음 모임·날씨·우천취소·랭킹 TOP3 · **광고 배너** · **운영진/회원 모드 전환** |
| 일정 | **캘린더·시간 선택**, **정기 모임 반복 등록**, RSVP, 운영진 대리 참석 체크 |
...
| 레벨업 | **원포인트**(영역별 유튜브 영상 — 검색·선반·앱 안 재생·봤어요/저장) · **용품**(검색·카테고리 선반·구매 링크) · **코치**(검색·지역 칩·상세에서 영상·전화) |
