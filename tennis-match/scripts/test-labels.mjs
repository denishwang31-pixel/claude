...
const NOT_SCREENS = new Set([
  ...
  '미등록', '앱에 등록됨', '대진 설정',
  // 대진·리그 화면 안의 버튼
  '대진 자동 작성', '수기 편집', '수기 작성', '저장하기', '되돌리기',
  // 코치 화면 안의 탭 — 메뉴가 아니라 화면 안에서 좌우로 나뉜 두 면
  '코치로 등록', '코치 찾기',
  // 로그인 화면
  '회원가입', '로그인',
  /* 화면 안의 구역 이름 — 메뉴가 아니라 그 화면을 열면 보이는 소제목.
     이런 것을 가리킬 때는 반드시 "[화면] → [구역]" 꼴로 적는다.
     구역 이름만 던지면 어느 화면을 열어야 하는지 알 수 없다. */
  '회비 청구 단위', '알림 종류', '이 코트장만 다르게', '대회 등록',
]);
