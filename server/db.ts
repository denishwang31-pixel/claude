...
export async function seedDefaultRules(userId: number): Promise<number> {
  ...
  const defaultRules: { keyword: string; category: string; isExact: boolean; ruleType: string }[] = [
    ...
    { keyword: "서브웨이", category: "식비", isExact: false, ruleType: "expense" },
    { keyword: "파파존스", category: "식비", isExact: false, ruleType: "expense" },
    { keyword: "피자헛", category: "식비", isExact: false, ruleType: "expense" },
    { keyword: "도미노", category: "식비", isExact: false, ruleType: "expense" },
    { keyword: "김밥천국", category: "식비", isExact: false, ruleType: "expense" },
